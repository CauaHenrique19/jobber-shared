...
export async function verifyGatewayRequest(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  try {
    const payload = JWT.verify(token, "") as { id: string; iat: number };
